...
<c> y un resto <r> donde <n> y <m> son los números introducidos
por el usuario, y <c> y <r> son el cociente y el resto de la división
...
c = int(n / m)
r = n % m
print(f"El cociente es: {c}, y el residuo es de: {r}")
